...
pw.println("<h3>Delete Employee (Module)</h3>");
pw.println("<br>");
pw.println("Are you sure you want to delete employee?<br>");
pw.println("Name: ");
pw.println("<b>" + employee.getName() + "</b><br>");
pw.println("Designation: ");
pw.println("<b>" + employee.getDesignation() + "</b><br>");
SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd/MM/yyyy");
pw.println("Date of birth: ");
pw.println("<b>" + simpleDateFormat.format(employee.getDateOfBirth()) + "</b><br>");
pw.println("Gender: ");
...
pw.println("<b>Not Indian</b><br>");
pw.println("Basic Salary: ");
pw.println("<b>" + employee.getBasicSalary().toPlainString() + "</b><br>");
pw.println("PAN number: ");
pw.println("<b>" + employee.getPANNumber() + "</b><br>");
pw.println("Aadhar card number: ");
pw.println("<b>" + employee.getAadharCardNumber() + "</b><br>");
...
pw.println("<button type='button'> No </button>");
pw.println("</a>");
pw.println("</form>");
pw.println("</div>");
...
{
System.out.println("In ConfirmDeleteDesignation");
sendBackView(response);
}
} catch(Exception exception)
{
System.out.println("In ConfirmDeleteDesignation1");
