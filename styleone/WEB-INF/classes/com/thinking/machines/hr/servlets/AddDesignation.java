...
pw.println("<h3> Designation Added </h3>");
pw.println("Add more?");
pw.println("<table>");
pw.println("<tr>");
pw.println("<td>");
...
pw.println("<div style='width:auto;height:72vh;margin:5px;margin-left:110px;border:1px solid black;'>");
pw.println("<h3>Add Designation (Module)</h3>");
pw.println("<br>");
pw.println("<div style='color:red'>" + daoException.getMessage() + "</div>");
pw.println("<br>");
pw.println("Designation : ");
pw.println("<form action='/styleone/addDesignation' onsubmit='return validateForm'>");
pw.println("<input type='text' id='title' name='title'>");
pw.println("<span id='designationErrorSection'> </span>");
pw.println("<br>");
pw.println("<br>");
